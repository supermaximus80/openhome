...
<h2>Gateway Simulator Control Panel - Version 3.8 - XMPP domain: <%=simulator.getXmppServerDomainName()%></h2>
...
<table>
    <tr>
        <td align="left">
            <% if (responseCode >= 0 && simulator.isXmppCnnected(cameraSelection)) { %>
            Response: XMPP Status Code <%=responseCode  %>
            <%} else if (responseCode >= 0 && !simulator.isXmppCnnected(cameraSelection)) { %>
