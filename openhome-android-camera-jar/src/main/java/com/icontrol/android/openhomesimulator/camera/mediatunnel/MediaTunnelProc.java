package com.icontrol.android.openhomesimulator.camera.mediatunnel;
...
import com.icontrol.android.openhomesimulator.camera.RtspURL;
import com.icontrol.android.openhomesimulator.camera.resources.SystemResource;
import com.icontrol.android.openhomesimulator.simplerelay.RelayThreadStatusCallBack;
...
public class MediaTunnelProc extends TimerTask implements RelayThreadStatusCallBack {
    ...
    //never used. Modified the content but not sure if correct

    private int createFailure(String method, String uriStr, String id) throws Exception {
        System.out.println("createFailure occures ");
